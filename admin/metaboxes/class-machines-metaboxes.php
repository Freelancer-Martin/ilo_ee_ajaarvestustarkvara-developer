<?php
add_action( 'cmb2_admin_init', 'render_machine_meta_box_content' );

function render_machine_meta_box_content( ) {

  $prefix = 'machines_fields_';
  ...
  $cmb_demo = new_cmb2_box( array(
    'id'            => $prefix . 'metabox',
    'title'         => esc_html__( 'Machine Metabox', 'ilo-ee-ajaarvestus-template' ),
    'object_types'  => array( 'add_machines_type' ), // Post type
  ...
  $cmb_demo->add_field( array(
    'name' => esc_html__( 'Insert Machine Name', 'ilo-ee-ajaarvestus-template' ),
    'desc' => esc_html__( 'Insert Machine name Here', 'ilo-ee-ajaarvestus-template' ),
